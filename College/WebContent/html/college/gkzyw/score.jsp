...
<html><head>
	...
	<title>院校分数线|大学查询|查分数-大学去哪儿</title>
...
$(document).ready(function(){
	...
	//	province =  $(this).text();
		...
		var action = "/user_front/saveCity.html;jsessionid=A708DDC09F7A6B3735633E91569BBA9E";
		$.ajax({
			type: "POST",
			url: action,
			cache: false,
...
<div id="main">
	<div class="w clearfix">
		...
		<b>志愿填报&nbsp;&gt;&nbsp;</b>
		<a href="score.jsp">查分数</a>&nbsp;&gt;&nbsp;
		<a href="score.jsp">院校分数线</a>
</b>
			</div>
			<div class="cut-style1"></div>
			<div class=" font-size14">
				<a class="tab-default tab-hover-style float-left" href="score.jsp">院校分数线</a>
			</div>
			<div class=" font-size14">
				<a class="tab-hover-style float-left" href="profession.jsp">专业分数线</a>
			</div>
			<div class=" font-size14">
			...
			<div class="clear"></div>
				...
				<div id="a0" class="screen-item1">
					<div class="screen-search">
						<input class="school" autocomplete="off" placeholder="请输入院校名称" name="schoolname" id="schoolname" type="text">
					</div>
				</div>
              ...
              <div class="inquiry2"><a href="javascript:void(0)">查&nbsp;&nbsp;询</a></div>
      	  </div>  
			<!--  </form>-->
			<div class="clear"></div>
	
			<div id="universityScore"><div style="display: none;">@start16@end</div><table cellpadding="0" cellspacing="0" border="0" style="text-align:center;">
	<tbody><tr>
		<td class="li-width13 border-bottom font-size14 line-height2 bg-color border-top"><div class="padding-left-style4">院校名称</div></td>
		<td class="li-width8 border-bottom font-size14 line-height2 bg-color border-top padding-left-style4">招生地区</td>
		...
		<td class="li-width8 border-bottom font-size14 line-height2 bg-color border-top">批次线</td>
	</tr>
	...
	if(message!=""){
	  if(confirm(message)){
		   window.location.href = "/VIPcard/index.html";
			...
			<div id="page">
				<div class="pagelist">
					<div class="page" style="display: block;">第1页/共16页</div>
